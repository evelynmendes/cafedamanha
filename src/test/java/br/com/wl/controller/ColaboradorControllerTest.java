...
public class ColaboradorControllerTest {
	...
	public void whenValidInput_thenReturnsSucess() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(MockMvcRequestBuilders.post("/api/colaboradores").contentType(MediaType.APPLICATION_JSON)
	...
	public void whenThrowDB() throws Exception {
		...
		Mockito.when(colaboradorRepository.inserir(ArgumentMatchers.isA(Colaborador.class)))
